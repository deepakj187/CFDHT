...
using namespace std;
/**************************GLOBAL VARIABLE************************/
const int n=11;      			// no of nodes                                              INPUT
...
int const d=2;
double li[d-1];
double l[d+1]={9,11,10};
int M[d+1]={5,3,3};
double s[d+1]={0};
double L;
double A1[d+1]={10.00,5.00,70.00};
double K1[d+1]={20.00,70.00,30.00};
double AK[n+1]={0};
//--------------------------------------------------------------------------------------------------------------------
...
int position =0;
  for (int i = 0; i < d+1; i++)
    for (int j=0;j<M[i];j++)
    {
        ...
        h_inf[position] = 10.00;
        T_inf[position] = 20.00;
        //q[position]=0.25;
        position+=1;
        }
        int mid=1;
